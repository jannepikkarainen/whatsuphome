# App BackupPC by Zabbix HTTP agent

## Description

The template to monitor BackupPC metrics API by Zabbix HTTP agent without need for extra scripts on server. Template Version v0.0.1 - Janne Pikkarainen, based on template by Evren Yurtesen Tested on Zabbix 6.2 and BackupPC 4.4.0 shipped with Ubuntu 22.04 LTS.
...
<https://github.com/jannepikkarainen/whatsuphome>
...
It is tested with the BackupPC 4.4.0 shipped with Ubuntu 22.04 LTS. It may function partially in older BackupPC versions.
...
Janne Pikkarainen, based on template by Evren Yurtesen
